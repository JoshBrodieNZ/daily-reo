...
Anake is a postposted particle (like [mai]({% post_url /daily-reo/2024-04-24-titiro-mai | prepend: site.baseurl %})) whose purpose is to indicate that the phrase it stands within is is an exhaustive list of the entities being referred to, equivalent to 'only' in English:
