...
I had a [little spiel the other day]({{ site.baseurl }}{% post_url /daily-reo/2024-04-25-pukumahi %}) about the prefix 'hia-' so I'll instead use today's word as a prompt to expand on that and talk about 'hiahia' which is the verb for 'to desire/want/wish for'.
